...
import 'package:flutter_ecommerce/features/personalization/screens/admin/widgets/product/upload_product_image.dart';
...
class AllProductsUploadImage extends StatelessWidget {
  const AllProductsUploadImage({super.key,
    required this.title,
    this.query,
    this.futureMethod
  });
        ...
        child: Padding(
          ...
          child: FutureBuilder(
              ...
              builder: (context, snapshot) {
                ...
                return TSortableUploadImageProducts(products: products);
              }
          ),
        ),
      ),
