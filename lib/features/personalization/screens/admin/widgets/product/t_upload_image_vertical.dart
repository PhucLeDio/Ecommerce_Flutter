...
class TProductCardUploadImageVertical extends StatelessWidget {
  const TProductCardUploadImageVertical({super.key, required this.product});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () => controller.uploadProductProfilePicture(product.id.toString()),
      child: Container(
        width: 180,
